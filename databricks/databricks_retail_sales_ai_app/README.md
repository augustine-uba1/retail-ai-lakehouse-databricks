# databricks_retail_sales_ai_app

The 'databricks_retail_sales_ai_app' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_retail_sales_ai_app_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_retail_sales_ai_app.job.yml). The schedule
